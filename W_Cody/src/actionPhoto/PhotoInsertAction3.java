 ...
 */
@WebServlet("/photo/insert3.do")
public class PhotoInsertAction3 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int res = PhotoDAO3.getInstance().insert( vo );
		
		response.sendRedirect("list3.do");
	}
