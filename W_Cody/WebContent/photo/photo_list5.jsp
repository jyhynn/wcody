...
<script type="text/javascript">
	...
	function download(filename) {
		...
		location.href = "download.do?dir=/upload5/&filename="
...
<style type="text/css">
.join {position: absolute; width: 80px; left: 49%; height:40px; background-color: #49C3FD; top: 15%; color:white; font-size:15px; text-align:center; padding:8px; 
...
<body>
	...
	<div id="mainbox">
		<div align="center">
			<input class="join" type="button" value="사진등록" onclick="location.href='insert_form5.do'">
		</div>
