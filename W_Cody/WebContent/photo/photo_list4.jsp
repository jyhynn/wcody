...
<script type="text/javascript">
	...
	function download(filename) {
		...
		location.href = "download.do?dir=/upload4/&filename="
...
<body>
	...
	<div id="mainbox">
		<div align="center">
			<input class="join" type="button" value="사진등록" onclick="location.href='insert_form4.do'">
		</div>
