...
<body>
	...
	<form action="insert.do"
		...
		<table border="1" align="center">
			...
			<caption>:::사진등록:::<br>(많이 함유된 소재 순으로 최대 두 종류를 골라주세요)</caption>
			...
			<tr>
				<th>업로드 할 사진</th>
				<td colspan="3"><input name="wphoto" type="file"></td>
			</tr>
			
			<tr>
				<th>색상</th>
				<td colspan="3"><input name="color"></td>
			</tr>
