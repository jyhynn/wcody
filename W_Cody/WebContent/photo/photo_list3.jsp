...
<script type="text/javascript">
	...
	function download(filename) {
		...
		location.href = "download.do?dir=/upload3/&filename="
...
<body>
	...
	<div id="mainbox">
		<div align="center">
			<input class="join" type="button" value="사진등록" onclick="location.href='insert_form3.do'">
		</div>
