...
<title>Insert title here</title>
	...
	<script type="text/javascript">
		function edit(){
			...
			location.href="fnq_edit_form.do?idx=" + idx;
		}
...
<body>
	...
	<table border="1">
		<tr id="tt">
			<td colspan="4">마이페이지 > <a href="fnq_list.do">F&Q</a> > 자주 묻는 질문</td>
		</tr>
		<tr>
		...
		<tr class="t_b">
			<td colspan="3" align="center"><div class="ch" onclick="location.href='fnq_list.do'" style="cursor:pointer;">목록으로</div></td>
		</tr>			
	</table>
</body>
</html>